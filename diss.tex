...
\usepackage{csquotes}
\usepackage[maxnames = 1, maxbibnames = 15, backend=biber, style=numeric, backref=true, doi=false,isbn=false,url=false, bibencoding=ascii]{biblatex}% style=numeric
