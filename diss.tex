...
\usepackage{csquotes}
\usepackage{biblatex}% style=numeric
...
\begin{document}
   ...
   \printbibliography[title={Publikationen mit Eigenbeteiligung}]%subbibnumbered,subbibliography
   \printbibliography[title={Weitere Literatur}]
