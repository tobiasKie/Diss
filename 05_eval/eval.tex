...
Die entwickelten Algorithmen sollen nun evaluiert werden. Dafür werden die neuen magnetischen Verfahren mit etablierten Verfahren verglichen werden.
\section{Verwendete Hardware}
Die Hardware besteht aus drei Komponenten, zum einen ein Auswertecomputer, eine AD/DA-Wandeleinheit und eine Stromverstärkereinheit. Der Auswertecomputer ist ein XXXX. Als AD/DA-Einheit werden zwei Soundkarten des Hersteller $RME\,Audio$ eingesetzt, eine M32 AD Pro und eine M1610 Pro. Diese sind über MADI miteinander verbunden, die Eingangsdaten der M1610 Pro werden dadurch über ein Lichtwellenleiter in Echtzeit an die M32 AD Pro gesendet. Das sorgt dafür, dass die Signale der beiden Einheiten synchronisiert am Auswertecomputer ankommen. Der Auswertecomputer generiert die Anregungssignale für die 3D-Spule und sendet diese an die DA-Einheit. Über die DA-Einheit werden über eine Verstärkereinheit in einen Strom gewandelt. Der Verstärker\footnote{Der Verstärker wurde in Projekt B1/B9 des SFB1261 an der CAU Kiel entwickelt und ein Exemplar für diesen Aufbau überlassen.} ist ein sechskanaliger Verstärker, von dem in der Evaluierung die ersten drei verwendet werden.

In Abbildung XX ist der Aufbau kurz dargestellt.

Abbildung Der Hardware
